    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {companies.map((company, index) => (
          <div key={index} className="border-2 rounded-lg bg-white hover:shadow-lg transition-shadow duration-200 overflow-hidden">
            <div className="p-6">
              <div className="flex items-center justify-between space-y-0 pb-2">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    {company.isNew && (
                      <Badge variant="outline" className="bg-green-100 text-green-700 w-fit mt-2 font-medium border-green-200">
                        Recently Added
                      </Badge>
                    )}
                  </div>
